...
export const productsItemsTest = [
  {
    id: 1,
...
export const categoriesTest = ["electronic", "home", "garden", "outside"];

export const loginTokenTest = {
  token: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9",
};

export const dataHandlers = [
  http.get(PRODUCTS, () => {
    return HttpResponse.json({ productsItemsTest });
  }),
  http.get(CATEGORIES, () => {
